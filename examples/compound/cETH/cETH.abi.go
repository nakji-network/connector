...
// CETHMetaData contains all meta data concerning the CETH contract.
var CETHMetaData = &bind.MetaData{
...
// Deprecated: Use CETHMetaData.ABI instead.
var CETHABI = CETHMetaData.ABI
