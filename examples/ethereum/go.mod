...
require (
	...
	github.com/nakji-network/connector v0.0.1-beta.1.0.20221215110320-ca39f332a517
	github.com/nakji-network/connector/chain/ethereum v0.0.0-20221215110320-ca39f332a517
